...
<title>Add Unit :: Sonnax Admin</title>
<!--[if IE]>
...
<div id="container">
	<div id="header_trans">
		<div class="header"><h3>Add Unit</h3></div>
	</div>
	...
	<div id="main">
		<div class="content">
			...
			<div class="long">
				...
				<input type='text' name='name' class='field' value="<?=htmlentities($_GET['pn'],ENT_COMPAT)?>"><BR>
				<div class="cleaner"></div>
				<div class='label'>Unit Description:</div>
				<textarea name="description" id="description" rows="5" cols="45"></textarea><BR>
				<div class="cleaner"></div>
				<div class='label'>Select Make:</div>
				<?
				$arrMakeData = getAllMakes();
				FormObjects::selectBoxAllMakes("make_id", $arrMakeData, "", "dropdown"); ?><BR>
				<div class="cleaner"></div>
				<div class='label'>Select Ref Figure:</div>
				<?
				$arrRefFigureData = getRefFigureData();
				FormObjects::selectBoxRefFigures("ref_figure_id", $arrRefFigureData, "", "dropdown"); ?><BR>
				<div class="cleaner"></div>
