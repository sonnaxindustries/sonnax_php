	...
	if ($TableEdit_strID == "0") { //Insert
		...
		//Create the Fields list
			for($x = 0;$x <= $TableEdit_intNumColumns;$x++) {
				...
				//build the Values list
					if ($arrTableData[$x][1] != "skip") { //dont include the fields we want to skip
						$sqlTempValues .= "'" . mysql_real_escape_string($arrTableData[$x][3]) . "'" . ",";
						...
						$sql_select_pairs .= "'" . mysql_real_escape_string($arrTableData[$x][3]) . "'";
					}
			} //x
		...
		//Create the Field/Data list
			for($x = 0;$x <= $TableEdit_intNumColumns;$x++) {
				...
				//build the field list	
					if ($arrTableData[$x][1] != "skip") { //dont include the fields we want to skip
						$sqlTempFieldsAndValues .= "`" . $arrTableData[$x][0] . "` = " . "'" . mysql_real_escape_string($arrTableData[$x][3]) . "'" . ",";
					}
			} //x
