	...
	<div id="main">
		<div class="content">
			...
			<div class="long">
				...
				<input size='60' type='text' name='assembly_name' class='field' value="<?=htmlentities($assembly_name,ENT_COMPAT)?>"><BR>
				<div class="cleaner"></div>
				<input type='submit' name='go' value='GO' class='submit' style='width:34px;'>
				<input type="hidden" name="action" value="edit_assembly_name">
