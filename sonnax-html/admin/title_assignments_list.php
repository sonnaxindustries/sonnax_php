...
<div id="container">
	...
	<div id="main">
		<div class="content">
			...
			<h4><?php echo $subcategory_title?> Sub-Category Contents</h4>
			<form name="form1" method="get" action="title_assignments_search.php">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search for titles to add to this sub-category beginning with... <input type="text" name="title" size="30"><input type="submit" value="GO">
		...
		<!-- START OF TITLE ROW -->
					...
					<div class='med_short' style='font-weight:bold;'>
						<a href="title_assignments_exe.php?action=remove&assignment_id=<?=$arr_titles["publication_subcategory_titles.id"][$x]?>&rd=<?=urlencode($rd)?>" onclick="return fVerifyAgreementUnitPart('<?=str_replace("'","",$part->part_number)?>')">Remove</a>
					</div>
