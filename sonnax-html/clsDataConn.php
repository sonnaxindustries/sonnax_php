...
Class DataConn {
	...
	public function __construct($database = "sonnax") {
        ...
        //$this->link = mysql_connect("localhost", "sonnax", "XbD.Srjf") // auto99parts
		//$this->link = mysql_connect("db.secure", "sonnax", "auto99parts")
		$this->link = mysql_connect("localhost", "sonnax", "auto99parts")
		or die ("Could not connect #4");
		mysql_select_db ($database)
		or die ("Could not select database #4");
