...
<title>Sonnax - Thank you for your order.</title>
<!--[if IE]>
...
<body>
<div id="container">
<div id="header_gen"><div class="header"><h3>Thank you<br>for your order</h3></div></div>
<?php require "nav.txt";?>
<div id="main">

<div class="content">
<h3>Thank you.<br>We will process your request shortly.</h3>
...
color:#000000;">Sign Up For Sonnax New Product Emails</td>
 </tr>
 <tr>
 <td align="center" style="border-top:2px solid #000000">
 <form name="ccoptin" action="http://visitor.constantcontact.com/d.jsp" target="_blank" method="post" style="margin-bottom:2;">
 <input type="hidden" name="m" value="1101913914829">
 <input type="hidden" name="p" value="oi">
 	<font style="font-weight: normal; font-family:Garamond,'Times New Roman',Times,serif; font-size:13px; color:#000000;">Email:</font>
