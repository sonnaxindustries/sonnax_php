...
Class DataConn {
	...
	function __construct($database) {
		$this->link = mysql_connect("localhost", "dbo198492749", "XbD.Srjf")
	 ...
	 * @return array
	 */
	function f_ReturnArray($sqlTemp) {
	 ...
	 * @return array
	 */
	function f_ReturnArrayOrdinal($sqlTemp) {
	 ...
	 * @return integer
	 */
	function f_ExecuteSqlInsertID($sqlTemp) {
