...
class Publications {
	...
	{
		$sql = "SELECT id,category FROM publication_categories ORDER BY category";
	...
	{
		$sql = "
			SELECT id,subcategory,publication_category 
	...
	public function lookupSubCategoryTitles($subcategory_id)
	{
		$sql = "
			SELECT 
