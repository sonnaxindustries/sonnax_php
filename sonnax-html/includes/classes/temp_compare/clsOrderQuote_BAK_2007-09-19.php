...
class OrderQuote extends Order {
	...
	private function createNewOrder () {
		$sql = "INSERT INTO `order` (TC) VALUES ({$this->tc})";
	...
	private function writeOrderName () {
		$sql = "UPDATE `order` SET `name` = '{$_GET["name"]}' WHERE id = {$this->order_id}";
	...
	public function sendOrderEmail () {
		...
		$strTo = "internetorders@sonnax.com,chris@vtweb.com,tomoffice@vtweb.com,terry@vtweb.com"; //internetorders@sonnax.com
