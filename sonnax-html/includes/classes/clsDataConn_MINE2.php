...
Class DataConn {
	...
	public function __construct($database = "sonnax") {
		...
		$this->link = mysql_connect("db2.vtweb.com", "sonnax", "XbD.Srjf")
	 ...
	 * @return array
	 */
	public function f_ReturnArrayAssoc_TF($sqlTemp) {
	 ...
	 * @return array
	 */
	public function f_ReturnArray($sqlTemp) {
	 ...
	 * @return array
	 */
	public function f_ReturnArrayOrdinal($sqlTemp) {
	 ...
	 * @return integer
	 */
	public function f_ExecuteSql($sqlTemp) {
	 ...
	 * @return integer
	 */
	public function f_ExecuteSqlInsertID($sqlTemp) {
