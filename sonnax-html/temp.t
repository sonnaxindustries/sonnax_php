...
if (strlen($message) > 0) {?>
	...
	<div class="cleaner"></div>
<?}?>
<form name="login_admin" method="post" action="login_validate.php">
	<div class="label">Username:</div><input type="text" name="username" class="field">
	<div class="cleaner"></div>
	<div class="label">Password:</div><input type="password" name="password" class="field">
	<div class="cleaner"></div>
	<div class="label">&nbsp;</div><input type="submit" name="submit" value="Login" class="button">
</form>
