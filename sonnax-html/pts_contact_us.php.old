...
<title>PTS Sonnax - Contact Sonnax</title>
<!--[if IE]>
...
<div class="content">
 ...
 <div align="left" class="content">
   <h3><strong>To Contact Sonnax<BR>
   </strong></h3>
   <h3><strong>Phone:<BR>
       <span class="form">For telephone assistance with any Sonnax Power Train Savers questions or requirements, during regular business hours (Mon &#8211; Fri. 8:30 am &#8211; 5:00 pm, Eastern Time), call: (800) 843-2600 or (802) 463-9722.</span><BR>
  &nbsp;<BR>
     Email:<BR>
     </strong><span class="form">For email assistance with any Sonnax Power Train Savers questions or requirements, submit your questions or comments below:</span> </h3>
 </div>
 <form name='register' id='register' method='get' action='pts_contact_us_exe.php' class='form' style='margin-left:50px;'>
