...
// Show the suggested list prioce only if the price is greater than zero
if ( $Part->price > 0 && $product_line_id == 3 ) {?>
<p><strong>Suggested List Price:</strong> $ <?php echo number_format( $Part->price, 2 );?><br /></p>
<?php }
